...
---
Hi there! I'm Chinmaya Kausik, a 3rd year mathematics Ph.D. candidate at UMich working on machine learning, statistics and optimization. My focus is on reinforcement learning, bandits and RLHF for LLMs. Lately, I have also been working on personal projects involving sequence models (LLMs, transformers, state space models). I am being co-advised by [Prof. Ambuj Tewari](https://ambujtewari.github.io/) and [Prof. Martin Strauss](https://lsa.umich.edu/math/people/faculty/martinjs.html).
